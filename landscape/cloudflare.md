...
| **webmail.aiqadam.org** | **A** | **95.46.211.224** | **false** | 1 (auto) | `d44ce1ab6990cf47848148634809463d` | **Roundcube webmail UI for @aiqadam.org users — owned by this repo** | **T-0122 / this repo** |
...
| **cms.qa.aiqadam.org** | **A** | **95.46.211.230** | **false** | 1 (auto) | `0b4ddd97899b5b7cd6d756a03c25e7ae` | **QA Directus public asset/API surface — owned by this repo.** Exposes `aiqadam-qa-directus-1` (127.0.0.1:3119) via nginx, sharing the `qa.aiqadam.org` certbot cert via SAN expansion. Added for FR-CMS-008/009's `/rules` source-document download links. | **T-0142 / this repo** |
...
**2026-07-23 post-T-0122 update:** 46 + 1 (`webmail.aiqadam.org` A record → `95.46.211.224`, proxied=false, record ID `d44ce1ab6990cf47848148634809463d`, created by T-0122) = **47 records**. Confirmed via Cloudflare API (step-07 PASS, 2026-07-23-deploy-roundcube-webmail-001).

**2026-08-21 post-T-0142 update:** 47 + 1 (`cms.qa.aiqadam.org` A record → `95.46.211.230`, proxied=false, ttl=1, record ID `0b4ddd97899b5b7cd6d756a03c25e7ae`, created by T-0142) = **48 records**. Confirmed via executor-infra's before/after full zone dump (47 → 48, exactly one added ID, zero changed/removed) and independently re-confirmed by [step-07 execution-validator](../runs/2026-08-21-expose-qa-directus-vhost-001/step-07-execution-validator.md).
